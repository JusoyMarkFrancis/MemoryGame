<script lang="ts">
    ...
    {#if !inGame}
      ...
      <div class="centered">
        <div class="button-container">
          ...
          <h1 class="main-heading">16 Cards</h1> 
  ...
  <style>
    ...
    .modal-button {
      ...
      transition: background-color 0.3s, transform 0.3s, box-shadow 0.3s ease-in-out; /* Smooth transition for hover */
      animation: slide-up 1s ease-out forwards; /* Apply animation only once */
    }
  
    /* Hover effect */
    .modal-button:hover {
      background-color: #d89d13; /* Darker yellow on hover */
      transform: scale(1.1) translateY(-8px) rotate(3deg); /* Slight scaling and movement */
      box-shadow: 0 10px 15px rgba(0, 0, 0, 0.3); /* Enhanced shadow */
    }
  
    /* Countdown and start text styles (unchanged) */
    .countdown-container {
      padding: 20px;
